<div id="pn_calendar">
    <center><h2><?php
            if ($this->show_month_selector) {
                ?>
                <select id="pn_calendar_month_selector">
    ...
    <div class="pn_calendar_list_container">
        <ul class="pn_calendar_list">
            <?php foreach ($week_days_names as $week_day_num => $name) : ?>
                <li><a class="daynames pn_other_month" href="#" data-week-day="<?php echo $week_day_num ?>"><?php echo $name ?></a></li>
            <?php endforeach; ?>

            <?php foreach ($cells as $cell) : ?>	
                <li><?php $cell->draw($events); ?></li>
            <?php endforeach; ?>
        </ul>
    </div>
